    ...
    [
      ...
      },
      {
        ...
        properties = {
          ...
          query  = format("SOURCE '%s' | fields @message | filter @message like /\\\"event\\\":\\\"http_request\\\"/ | filter @message like /\\\"service\\\":\\\"%s\\\"/ | parse @message /\\\"path\\\":\\\"(?<cwobs_path>[^\"]+)\\\"/ | parse @message /\\\"status\\\":(?<cwobs_status>[0-9]{3})/ | parse @message /\\\"duration_ms\\\":(?<cwobs_duration>[0-9.]+)/ | filter ispresent(cwobs_path) and ispresent(cwobs_status) and ispresent(cwobs_duration) | stats count(*) as request_count, pct(cwobs_duration, 50) as cwobs_p50_latency, pct(cwobs_duration, 90) as cwobs_p90_latency, pct(cwobs_duration, 95) as cwobs_p95_latency, pct(cwobs_duration, 99) as cwobs_p99_latency by cwobs_path, cwobs_status | sort request_count desc | fields cwobs_path as Path, cwobs_status as Status, cwobs_p50_latency as p50_latency, cwobs_p90_latency as p90_latency, cwobs_p95_latency as p95_latency, cwobs_p99_latency as p99_latency, request_count as Requests | display Path, Status, p50_latency, p90_latency, p95_latency, p99_latency, Requests | limit 100", local.app_log_group_name, var.frontend_service_name)
          region = var.region
          view   = "table"
        }
      },
      ...
      },
      {
        ...
        properties = {
          ...
          query  = format("SOURCE '%s' | fields @message | filter @message like /\\\"event\\\":\\\"http_request\\\"/ | filter @message like /\\\"service\\\":\\\"%s\\\"/ | parse @message /\\\"path\\\":\\\"(?<cwobs_path>[^\"]+)\\\"/ | parse @message /\\\"status\\\":(?<cwobs_status>[0-9]{3})/ | parse @message /\\\"duration_ms\\\":(?<cwobs_duration>[0-9.]+)/ | filter ispresent(cwobs_path) and ispresent(cwobs_status) and ispresent(cwobs_duration) | stats count(*) as request_count, pct(cwobs_duration, 50) as cwobs_p50_latency, pct(cwobs_duration, 90) as cwobs_p90_latency, pct(cwobs_duration, 95) as cwobs_p95_latency, pct(cwobs_duration, 99) as cwobs_p99_latency by cwobs_path, cwobs_status | sort request_count desc | fields cwobs_path as Path, cwobs_status as Status, cwobs_p50_latency as p50_latency, cwobs_p90_latency as p90_latency, cwobs_p95_latency as p95_latency, cwobs_p99_latency as p99_latency, request_count as Requests | display Path, Status, p50_latency, p90_latency, p95_latency, p99_latency, Requests | limit 100", local.app_log_group_name, var.backend_service_name)
          region = var.region
          view   = "table"
        }
      },
